				...
				<tbody>
					<tr>
						<td class="text-left" width="20%">
							<img src="libs/images/logotm.jpg" alt="logo-dkm" width="70" />
						</td>
						<td class="text-center" width="60%">
						<b>PT. Tama Sejahtera</b> <br>
						Jl. Al Hidayah, Bedahan, Kabupaten Sawangan, Depok, Jawa Barat 17520<br>
						Telp: (021) 89115030<br>
						<td class="text-right" width="20%">
							<img src="libs/images/isk_1.jpg" alt="logo-dkm" width="130" height="70"/>
						</td>
					</tr>
				</tbody>
			</table>

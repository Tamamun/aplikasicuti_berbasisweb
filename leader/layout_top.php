...
<head>
	...
	<title>Sistem Informasi Pengajuan Cuti Online PT. Tama Sejahtera - <?php echo $pagedesc ?></title>

	<link href="libs/images/logotm.jpg" rel="icon" type="images/x-icon">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="../libs/images/logotm.jpg" alt="brand" width="32" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>PT. Tama Sejahtera</strong></div>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
							<h4>Sistem Informasi Pengajuan Cuti Online <br> <b>PT. Tama Sejahtera</b></h4>
